...
public class Program_literal {
  ...
  public void run() throws IOException {
    ...
    LocatedProp subject = LocatedProp.fromJSON(new JSONObject("{\"loc\":{\"result\":{\"external\":false,\"depth\":0,\"start\":0,\"end\":0,\"type\":\"ast.Program\"},\"steps\":[]},\"prop\":{\"args\":[{\"type\":\"integer\",\"value\":0}],\"name\":\"literal\"}}"));
    ...
    for (int repeat = 0; repeat < 16; ++repeat) {
      ...
      assertEquals("Failed test for Program_literal", reference, reeval);
    }
