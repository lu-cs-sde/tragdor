...
public class Num_label2 {
  ...
  public void run() throws IOException {
    ...
    LocatedProp subject = LocatedProp.fromJSON(new JSONObject("{\"loc\":{\"result\":{\"external\":false,\"depth\":3,\"start\":0,\"end\":0,\"type\":\"ast.Num\"},\"steps\":[{\"type\":\"child\",\"value\":0},{\"type\":\"child\",\"value\":0},{\"type\":\"child\",\"value\":0}]},\"prop\":{\"name\":\"label2\"}}"));
    ...
    for (int repeat = 0; repeat < 16; ++repeat) {
      ...
      assertEquals("Failed test for Num_label2", reference, reeval);
    }
